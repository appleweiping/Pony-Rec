...
def _metadata_from_args(args: argparse.Namespace) -> dict[str, Any]:
    hash_payload = {
        ...
        "rank_input_path": args.rank_input_path,
    ...
    config_hash = args.config_hash or _stable_hash(hash_payload)
    return {
        "dataset": args.dataset,
        "domain": args.domain,
        "split": args.split,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_backend", default="derived_bridge")
    parser.add_argument("--prompt_id", default="shadow_v6_signal_to_decision")
    parser.add_argument("--config_hash", default=None)
    parser.add_argument(
        "--artifact_class",
        default="diagnostic",
        choices=["smoke", "pilot", "diagnostic", "paper-result"],
    )
