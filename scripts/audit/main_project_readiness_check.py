...
REQUIRED_FILES = [
    ...
    "docs/archive/legacy_root_reports/PROJECT_LINEAGE_AND_FILE_INDEX_2026-05-06.md",
    ...
    "configs/paper_manual_submission_checklist.json",
    ...
    "scripts/audit/main_audit_official_external_repos.py",
    "scripts/audit/main_audit_official_fairness_policy.py",
    "scripts/adapters/main_run_official_same_candidate_adapter.py",
    "scripts/adapters/main_run_llm2rec_official_same_candidate_adapter.py",
    "scripts/adapters/main_run_llmesr_official_same_candidate_adapter.py",
    "scripts/adapters/main_run_llmemb_official_same_candidate_adapter.py",
    "scripts/adapters/main_run_rlmrec_official_same_candidate_adapter.py",
    "scripts/adapters/main_run_irllrec_official_same_candidate_adapter.py",
    "scripts/adapters/main_run_setrec_official_same_candidate_adapter.py",
    "scripts/adapters/main_run_elmrec_official_same_candidate_adapter.py",
    "scripts/adapters/main_run_proex_official_same_candidate_adapter.py",
    "scripts/adapters/main_run_promax_official_same_candidate_adapter.py",
    "scripts/train/main_train_score_elmrec_upstream_adapter.py",
