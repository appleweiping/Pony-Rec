...
command_script="outputs/summary/week8_large10000_100neg_generated_title_scaffold_commands.sh"
log="outputs/summary/logs/week8_generated_title_scaffold_$(date +%F_%H%M%S).log"
