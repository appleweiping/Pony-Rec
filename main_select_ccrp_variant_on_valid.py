...
def main() -> None:
    ...
    if best is None:
        ...
        raise RuntimeError(
            "No selectable C-CRP validation row passed coverage and score-degeneracy gates. "
    ...
    test_row = {
        ...
        "weight_boundary": best["weight_boundary"],
        "weight_calibration_gap": best["weight_calibration_gap"],
        "weight_evidence": best["weight_evidence"],
        "weight_grid_label": best["weight_grid_label"],
        ...
        "score_modes_grid": score_modes,
        "ablations_grid": ablations,
        "etas_grid": etas,
        "confidence_weights_grid": confidence_weights,
