...
Generated: 2026-06-14T21:21:55.653842+00:00
...
- `submission_package`: ok=`false`, ready=`false`, final_ready=`false`, path=`outputs\summary\paper_critical\submission_package_audit_20260614.json`
...
- `external_proceedings_metadata`: ok=`true`, ready=`false`, final_ready=`false`, path=`outputs\summary\paper_critical\external_proceedings_metadata_recheck_20260614.json`
