...
Generated: 2026-06-14T21:21:58.869909+00:00
...
- `pre_submission_gate_refresh`: ok=`false`, ready=`false`, json=`outputs\summary\paper_critical\pre_submission_gate_refresh_20260614.json`
- `pre_submission_refresh_freshness`: ok=`true`, ready=`true`, json=`outputs\summary\paper_critical\pre_submission_gate_refresh_freshness_20260614.json`
- `submission_release_candidate`: ok=`false`, ready=`false`, json=`outputs\summary\paper_critical\submission_release_candidate_20260614.json`
