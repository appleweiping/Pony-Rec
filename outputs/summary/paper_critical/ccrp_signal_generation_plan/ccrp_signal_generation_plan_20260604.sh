...
python scripts/audit/main_audit_ccrp_uncertainty_sources.py \
  ...
  --source candidate_signal=outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_sports/valid_ccrp_signal_rows.csv \
  --expected_events 10000 \
  --expected_candidates_per_event 101 \
  --output_json outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_sports/valid_ccrp_signal_source_audit.json \
  --output_csv outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_sports/valid_ccrp_signal_source_audit.csv
...
python scripts/audit/main_audit_ccrp_uncertainty_sources.py \
  ...
  --source candidate_signal=outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_sports/test_ccrp_signal_rows.csv \
  --expected_events 10000 \
  --expected_candidates_per_event 101 \
  --output_json outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_sports/test_ccrp_signal_source_audit.json \
  --output_csv outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_sports/test_ccrp_signal_source_audit.csv
...
python scripts/audit/main_audit_ccrp_uncertainty_sources.py \
  ...
  --source candidate_signal=outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_toys/valid_ccrp_signal_rows.csv \
  --expected_events 10000 \
  --expected_candidates_per_event 101 \
  --output_json outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_toys/valid_ccrp_signal_source_audit.json \
  --output_csv outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_toys/valid_ccrp_signal_source_audit.csv
...
python scripts/audit/main_audit_ccrp_uncertainty_sources.py \
  ...
  --source candidate_signal=outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_toys/test_ccrp_signal_rows.csv \
  --expected_events 10000 \
  --expected_candidates_per_event 101 \
  --output_json outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_toys/test_ccrp_signal_source_audit.json \
  --output_csv outputs/summary/paper_critical/ccrp_signal_generation_plan/ccrp_signal_rows_toys/test_ccrp_signal_source_audit.csv
