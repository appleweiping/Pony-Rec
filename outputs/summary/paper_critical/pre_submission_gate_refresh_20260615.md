...
Generated: 2026-06-15T01:19:00.461089+00:00
...
- Stamp: `20260615`
- Git HEAD before refresh: `55cc34d081f29662d6ea294ff7d167d0b669d137`
- Tracked dirty before refresh: `false`

## Steps

- `external_proceedings_metadata`: ok=`true`, ready=`false`, json=`outputs\summary\paper_critical\external_proceedings_metadata_recheck_20260615.json`
- `submission_package`: ok=`false`, ready=`false`, json=`outputs\summary\paper_critical\submission_package_audit_20260615.json`
- `submission_source_package`: ok=`false`, ready=`false`, json=`outputs\summary\paper_critical\submission_source_package_20260615.json`
- `submission_source_package_rebuild`: ok=`false`, ready=`false`, json=`outputs\summary\paper_critical\submission_source_package_rebuild_20260615.json`
- `submission_metadata_packet`: ok=`false`, ready=`false`, json=`outputs\summary\paper_critical\submission_metadata_packet_20260615.json`
- `manual_submission_checklist`: ok=`false`, ready=`false`, json=`outputs\summary\paper_critical\manual_submission_checklist_20260615.json`
- `final_submission_gate`: ok=`false`, ready=`false`, json=`outputs\summary\paper_critical\final_submission_gate_20260615.json`
...
- `outputs\summary\paper_critical\review_continuation_packet_20260615.json`: `52c0cbe6f64406f2986ab1751c15dcbeb58b11bb7d03f726e4fc97fef87dbb68` (15973 bytes)
...
- `final_submission_gate:review_continuation:not_ok`
- `final_submission_gate:review_continuation:not_ready`
- `final_submission_gate:review_continuation:submission_package_audit_not_ok`
- `final_submission_gate:review_continuation:release_candidate_stack_not_local_ready`
- `final_submission_gate:review_continuation:closure_packet_not_ready_or_has_other_blockers`
