...
python scripts\audit\main_remote_official_evidence_audit.py `
  --remote_evidence_dir outputs/tools_large10000_100neg_irllrec_intent_official_qwen3base_same_candidate `
  --mode server_final `
...
python scripts\audit\main_sync_official_evidence_package.py `
  --remote_evidence_dir outputs/tools_large10000_100neg_irllrec_intent_official_qwen3base_same_candidate `
  --local_evidence_dir outputs\baselines\official_adapters\tools_large10000_100neg_irllrec_intent_official_qwen3base_same_candidate `
  --copy `
  --quiet

# local_light_audit
python scripts\audit\main_audit_official_evidence_package.py `
  --evidence_dir outputs\baselines\official_adapters\tools_large10000_100neg_irllrec_intent_official_qwen3base_same_candidate `
  --mode local_light `
  --expected_users 10000 `
  --expected_candidates_per_user 101 `
  --output_json outputs\baselines\official_adapters\tools_large10000_100neg_irllrec_intent_official_qwen3base_same_candidate\local_light_evidence_audit.json `
  --quiet
