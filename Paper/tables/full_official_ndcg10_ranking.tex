...
\caption{Complete same-candidate NDCG@10 ranking for the four new domains. Each domain contains 10,000 users, 101 candidates per user, one C-CRP row, and all eight official-code-level baseline rows. A \textit{Random} reference (NDCG@10$=$0.045, HR@10$=$0.099, MRR$=$0.051; analytical expectation for one positive among 101 candidates) calibrates the absolute scale: rows near this floor (e.g.\ ELMRec) retain little same-candidate signal once their native serving stack is replaced by the unified Qwen3-8B backbone, whereas \method{} and the strongest baseline LLMEmb are well above it.}
...
Sports & \textit{Popularity} & -- & 0.0484 & 0.1050 & 0.0535 \\
\midrule
...
Toys & \textit{Popularity} & -- & 0.0465 & 0.0996 & 0.0525 \\
\midrule
...
Home & \textit{Popularity} & -- & 0.0454 & 0.0977 & 0.0508 \\
\midrule
...
Tools & \textit{Popularity} & -- & 0.0415 & 0.0900 & 0.0486 \\
\bottomrule
\end{tabular}
\end{table*}
