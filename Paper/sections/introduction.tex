...
strongest baseline; on these six domains it leads on essentially all seven
metrics (HR@5/@10/@20, NDCG@5/@10/@20, MRR). It is not first in the other two:
on Beauty it is rank~2, $-11\%$ on NDCG@10 behind ProEx, and on Movies it is
rank~5, $-24\%$ behind LLMEmb. We state these two losses openly rather than
...
the full family within $\approx 0.003$ NDCG@10. The boundary-uncertainty term is
...
\begin{enumerate}
    ...
    leading on essentially all seven metrics in those six domains. We report the
