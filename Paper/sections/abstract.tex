...
advantage largely survives frozen-model substitution, we re-run the identical
pipeline under two additional different-family LLMs (Llama-3.1-8B-Instruct and
Mistral-7B-Instruct-v0.3) across all eight domains: $17$ of the
$18$ backbone$\,\times\,$(winning-domain) cells clear the strongest official
baseline (Mistral first in all six, Llama in five; Llama-Books a $1.0\%$
