...
Phase 2: 8 official baselines on 4 new domains (sports running with llmemb+proex_profile+promax_profile+elmrec_graph complete and irllrec_intent active; toys/home/tools pending; scripts/run_baselines_new_domains.sh; SETRec excluded while blocked; single-domain loop; full @5/@10/@20+MRR import after each score audit)
