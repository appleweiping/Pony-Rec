...
## Experiment Roadmap（2026-06-05 更新）

```text
Phase 1: C-CRP v3 on 8 domains (sports✓ toys✓ home✓ tools✓)
Phase 2: 8 official baselines on 4 new domains (sports✓ 8/8 + gate✓; toys✓ 8/8 + gate✓; home✓ 8/8 + gate✓ with C-CRP rank 1 on all 7 metrics and 56/56 positive Holm-significant paired tests; tools 6/8 gated✓ with proex_profile, promax_profile, elmrec_graph, llmemb, irllrec_intent, rlmrec_graphcl; latest Tools RLMRec completion/gate 2026-06-05 12:49 CST with server-final audit✓, local-light audit✓, full metrics HR@5/10/20 0.0784/0.1354/0.2465, NDCG@5/10/20 0.050175/0.068389/0.095993, MRR 0.072201, exact score coverage 1.0, and post-gate cleanup preserving final scores/provenance/audits/tables/model; first Tools LLM2Rec launch at 2026-06-05 13:02 CST failed during validation export because the Tools valid candidate CSV was truncated, and the CSV was repaired from ranking_valid with audit manifests `outputs/summary/tools_valid_candidate_items_repair_20260605T051943Z.json` and `outputs/summary/tools_valid_candidate_items_repair_validation_20260605T0520Z.json`; Tools LLM2Rec relaunched at 2026-06-05 13:43 CST as the seventh single-row Tools official baseline with runner PID `3413921`, adapter PID `3413930`, log `baselines_new_domains_tools_llm2rec_20260605_134355.log`, heartbeat `monitor-tools-llm2rec`, and launch snapshot `outputs/summary/tools_llm2rec_launch_monitor_20260605.json`; embedding is active and the row is not table-eligible until completion gates pass; remaining Tools row after LLM2Rec is llmesr_sasrec; scripts/run_baselines_new_domains.sh; SETRec excluded while blocked; single-domain loop; full @5/@10/@20+MRR import after each score audit)
