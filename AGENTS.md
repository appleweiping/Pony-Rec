...
Phase 2: 8 official baselines on 4 new domains (sports running; toys/home/tools pending; scripts/run_baselines_new_domains.sh; SETRec excluded while blocked; single-domain loop; full @5/@10/@20+MRR import after each score audit)
