...
Phase 2: 8 official baselines on 4 new domains (sports✓ 8/8 + gate✓; toys✓ 8/8 + gate✓; home✓ 8/8 + gate✓ with C-CRP rank 1 on all 7 metrics and 56/56 positive Holm-significant paired tests; tools 5/8 gated✓ with proex_profile, promax_profile, elmrec_graph, llmemb, irllrec_intent; remaining tools rows are rlmrec_graphcl, llm2rec_sasrec, llmesr_sasrec; latest Tools IRLLRec gate completed 2026-06-05 05:29 CST with local-light package PASS and completed adapter cleanup recovering disk to about 14G free / 93% used; scripts/run_baselines_new_domains.sh; SETRec excluded while blocked; single-domain loop; full @5/@10/@20+MRR import after each score audit)
